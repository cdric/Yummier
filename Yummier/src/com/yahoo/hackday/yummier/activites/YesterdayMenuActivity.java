...
public class YesterdayMenuActivity extends AbstractMenuActivity {
	...
	protected void setUpActivity() {
		...
		if (previousBusinessDay.getDayOfWeek() <= DateTimeConstants.MONDAY) {
			...
			previousBusinessDay = previousBusinessDay.withDayOfWeek(DateTimeConstants.FRIDAY);
		} else {
			previousBusinessDay = previousBusinessDay.minusDays(1);
		}
		
		String dateCode = formatter.print(previousBusinessDay);
